...
/**
 * Logs a word press and what the dictionaries made of it: the matched text and its
 * dictionary form when something matched, otherwise the text the press scanned.
 */

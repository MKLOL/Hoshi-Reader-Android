...
class MangaPageZoomInstrumentedTest {
    ...
    @Test
    fun openingAndJumpingFromZoomedPageFitsAndAllowsSwipe() {
        ...
        bitmap.recycle()
        val book = MokuroBook("Zoom fixture", List(3) { MokuroPage(it, "page.png", 400, 600, emptyList()) }, null)
            ...
            if (visible) BoxWithConstraints(Modifier.fillMaxSize()) {
                MangaReaderWebView(
                    ...
                    renderConfig = MangaPageRenderConfig("#ffffff", false, false,
                        maxWidth.value.toInt(), maxHeight.value.toInt(), selectionScript = ""),
